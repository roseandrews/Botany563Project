...
### MrBayes
Description - Software used for Bayesian inferences using MCMC methods to estimate posterior distributions. Strengths - Provides posterior probabilities, supports a lot of models (GTR, HKY), can combine molecular and morphological data. Weaknesses - MCMC can be slow, 
