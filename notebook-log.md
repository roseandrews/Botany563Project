...
9. Following the methods from the "Distance/Parsiomny methods (Part 3: computer lab)" from the Botany 563 Course website, I created a basic NJ tree from the R packages ape and phangorn.
Software - Ape 
